...
import 'package:smartlandtransaction/constant/constants.dart' as constant;
...
class MetaMaskProvider extends ChangeNotifier {
  ...
  final abi = [
    ...
    "function UserMapping(address) public view returns(address id,string name,uint age,string city,string nin,string phone,string document,string email,bool isUserVerified)",
    ...
    "function registerUser(string memory _name, uint _age, string memory _city,string memory _nin, string memory _phone, string memory _document, string memory _email) public",
  ...
  registerUser(String name, String age, String city, String nin, String phone,
      String document, String email) async {
    await contract.send(
      'registerUser',
      [name, age, city, nin, phone, document, email],
    );
  }
