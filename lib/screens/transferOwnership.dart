...
import 'package:smartlandtransaction/constant/constants.dart';
import 'package:smartlandtransaction/providers/LandRegisterModel.dart';
import 'package:smartlandtransaction/providers/MetamaskProvider.dart';
import 'package:smartlandtransaction/widget/land_container.dart';
    ...
    pdf.addPage(pw.Page(
        ...
        build: (pw.Context context) {
          return pw.Column(
              ...
              children: [
                pw.Center(
                  child: pw.Text('THE REPUBLIC OF UGANDA'),
                ),
                pw.Center(child: pw.Text('THE LAND ACT, CAP 227')),
                pw.Center(child: pw.Text('THE LAND REGULATIONS, 2004')),
                pw.Center(child: pw.Text('Form 33')),
                pw.Center(child: pw.Text('Form 33')),
                ...
                pw.Table(columnWidths: {
                  ...
                  tableRowSizedBox(),
                  tableRow("10)Stamp Duty paid amount:", "UGX 6000"),
                  tableRowSizedBox(),
                  tableRow("11)Registration Serial No.:", "613"),
                  tableRowSizedBox(),
                  tableRow("12)Registration Fee:", "UGX 5000"),
                  tableRowSizedBox(),
                ]),
                pw.Divider(height: 2),
                pw.Divider(height: 2),
